        ...
        <div className="Database-Content-Container-Margin">
            ...
            <div className="Database-Windows-Container">
                ...
                <div className="Database-Windows-Content-Margin">{
                    ...
                    databaseConecctionData.map(({ lastDatabaseChangeDate, databaseName, databaseKey, lastDatabaseUsersChangePhotoURL, databaseStoreSpace }) => {

                        return <div className="Database-Window-Container" key={databaseKey} onClick={() => { goDatabaseViewInCollection(databaseName) }}>
