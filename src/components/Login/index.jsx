...
import WebTopNavBar from '../shared/WebTopNavBar'
                    ...
                    <div className="Login-View-Content-Container">
                        ...
                        <div className="Login-View-Content-Container-Text-Container">
                            ...
                            <div className="Login-View-Content-Container-Text-Content">
                                ...
                                <p className="Login-View-Title-Label"><p className="Login-View-Title-AppName-Label">Datasync</p>, Tu area de trabajo ideal.</p>
                                ...
                                <div className="Login-View-Animation-Container">
                                    ...
                                    <lottie-player
                                        ...
                                        loop
                                        mode="normal"
                                        src="https://assets7.lottiefiles.com/packages/lf20_3jmvq04g.json"
                                    ></lottie-player>
